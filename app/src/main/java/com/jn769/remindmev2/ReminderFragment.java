...
////            ReminderViewAdapter adapter = new ReminderViewAdapter(
////                    dataList);
////            recyclerView.setAdapter(adapter);
//        }
//
//        FloatingActionButton fab = view.findViewById(R.id.main_add_fab);
//        fab.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                ((NavigationHost) getActivity()).navigateTo(new AddReminderFragment(), false); // Navigate to the next Fragment
//            }
//        });
//
//
